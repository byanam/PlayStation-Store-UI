...
- **Scroll-Driven Gradients**: Real-time linear gradient morphing across typography and interactive promo sections.
- **Glassmorphic Cart Drawer**: Interactive sliding drawer with live item counters and pricing state.
- **Asset Optimization**: High-efficiency WebP image pipelines with eager fetch priority and sub-second paint times.
- **Pure Vanilla Architecture**: Zero framework overhead, 100% dependency-free.
...
- **Vanilla JavaScript (ES6+)** — Touch gestures, scroll interpolation, and cart state management
